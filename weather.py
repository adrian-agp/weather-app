...
def getWeather():
    ...
    #weather
    api="https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=2d8aa4b50bf1d95da6e2f6f5c7b8d993"
    api="https://api.openweathermap.org/data/2.5/onecall?lat=20.025&lon=-75.800&units=metric&exclude=hourly&appid=2d8aa4b50bf1d95da6e2f6f5c7b8d993"

    json_data = requests.get(api).json()

    ## current
    temp = json_data['current']['temp']
    humedity = json_data['current']['humedity']
    pressure = json_data['current']['pressure']
    wind = json_data['current']['wind_speed']
    description = json_data['current']['weather'][0]['description']

    t.config(text=(temp,"°C"))
    h.config(text=(humedity,"%"))
    ...
    tempday6 = json_data['daily'][6]['temp']['day']
    tempnight6 = json_data['daily'][6]['temp']['night']
    ...
    tempday7 = json_data['daily'][7]['temp']['day']
    tempnight7 = json_data['daily'][7]['temp']['night']
...
label5=Label(root,text="Descriptions",font=('Helvetica',11),fg="white",bg="#203243")
label5.place(x=50,y=2000)
...
Search_ico=PhotoImage(file="images/search_icon.png")
myimage_ico=Button(image=Search_ico,borderwidth=0,cursor="hand2",bg="#203243", command=getWeather)
myimage_ico.place(x=645,y=125)
...
fouthimage=Label(fourthframe,bg="#282829")
